...
console.log(`I'm walking with my ${nouns[getRandomIndexOfArray(nouns)]}, and I encounter a(n) ${adjectives[getRandomIndexOfArray(adjectives)]} ${nouns[getRandomIndexOfArray(nouns)]}. 
I ${verbs[getRandomIndexOfArray(verbs)]} with them, but my ${nouns[getRandomIndexOfArray(nouns)]} is becoming ${adjectives[getRandomIndexOfArray(adjectives)]}, so I ${verbs[getRandomIndexOfArray(verbs)]} to the ${nouns[getRandomIndexOfArray(nouns)]}.  
We ${verbs[getRandomIndexOfArray(verbs)]} into the ${adjectives[getRandomIndexOfArray(adjectives)]} ${nouns[getRandomIndexOfArray(nouns)]} and the ${nouns[getRandomIndexOfArray(nouns)]} ${verbs[getRandomIndexOfArray(verbs)]} us all the way home.`);
